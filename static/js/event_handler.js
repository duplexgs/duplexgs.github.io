document.addEventListener('DOMContentLoaded', domReady);
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        image.src = './static/images/results/kitchen1';
                        break;
                    case 3:
                        image.src = './static/images/results/kitchen2';
                        break;
                }
                switch (i) {
                    case 0:
        ...
        function additionalSceneEvent(idx) {
            let dics = document.getElementById('additional-dics');
            if (!dics) return;
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = './static/images/results/dj';
                        break;
                    case 1:
            ...
            let scene_list = document.getElementById("additional-scale-recon").children;
            for (let i = 0; i < scene_list.length; i++) {
                if (idx == i) {
                    scene_list[i].children[0].className = "nav-link active";
                } else {
